...
function createChart_SMI_SalePerBill(graphName,graphType,graphSeries,graphCategory,arIndex) {
	//alert(graphName);
...
var htmlParam_SMI_SalePerBill = function(){
	 var htmlParam ="";
...
function salesPerBillWeeklyFn(graphName,graphType,arIndex,startDate,endDate,brach){
	alert("salePerDay22222222222222222222222");
	 $.ajax({
			...
			success:function(data2){
				...
				$.each(data2,function(index2,indexEntry2){
					...
					if(index2==0){
						...
						dataSeriesSaleAmountLastYear+="\""+indexEntry2[3]+"\"";
						dataSeriesSaleTarget+="\""+indexEntry2[1]+"\"";
					}else{
						categories+=",\""+indexEntry2[0]+"\"";
						dataSeriesSaleAmount+=",\""+indexEntry2[2]+"\"";
						dataSeriesSaleAmountLastYear+=",\""+indexEntry2[3]+"\"";
			 ...
			 */
				...
				//console.log(series);
				 createChart_SMI_SalePerBill(graphName,graphType,series,objCategories,arIndex);
			}
		});
	};
