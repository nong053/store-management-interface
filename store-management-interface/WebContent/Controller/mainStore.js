 ...
 */	
	...
	$("#loading").ajaxStart(function(){
		...
		if(ajaxCount==1){
		//$("#loadBranch").css({"top":hieghtImg+"px","left":widthImg}).show();
		ajaxCount++;
		}
	});
...
var createLayoutGraphNotReturn = function(graphName,graphType,graphId,arIndex,graphNameThaiLanguage){
		...
		htmlLayoutGraph="<div class=\"graphBoxArea\">" +
							"<div class=\"graphTop\" id=\"area"+graphName+"-"+arIndex+"\">" +
								...
								if(graphName=="SalePerMonth"){
									htmlLayoutGraph+=	"" +
											"<div id=\"boxSalePerMonthMTD\">" +
											"<div id=\"chartMTD"+graphName+"-"+arIndex+"\"  class=\"chart chartMTD\"></div>" +
									...
									htmlLayoutGraph+=	"" +
											"<div id=\"boxSalePerMonthYTD\">" +
											"<div id=\"chartYTD"+graphName+"-"+arIndex+"\"  class=\"chart chartYTD\"></div>" +
		...
		if(slotPosition==1){
			...
			htmlLayoutGraphMyView+=	"<div class=\"graphTop\" id=\"area"+graphName+"-"+slotPosition+"\">" +
						...
						if(graphName=="SalePerMonth"){
							...
							"<div id=\"boxSalePerMonthMTD\">" +
							"<div id=\"chartMTD"+graphName+"-"+slotPosition+"\"  class=\"chart chartMTD\"></div>" +
							"<div id=\"lengendSalePerMonthMTD\" class=\"lengendSalePerMonth\">" +
							...
							htmlLayoutGraphMyView+=	"" +
							"<div id=\"boxSalePerMonthYTD\">" +
							"<div id=\"chartYTD"+graphName+"-"+slotPosition+"\"  class=\"chart chartYTD\"></div>" +
							"<div id=\"lengendSalePerMonthYTD\" class=\"lengendSalePerMonth\">" +
								"<div class=\"rowLengendSalePerMonth\">" +
									"<div class=\"columnLengendSalePerMonth\">" +
										"<table>" +
	...
	var createGraphByGaraphName=function(graphName,graphType,arIndex){
		...
		if(graphName=="SalePerDay"){
			...
			//Defualt Parameter Start
					 ...
					 var vBranchDefault =firstBranchCode;
					 var vYear="";
					 var vMonth="";
					 var vBranch="";
					 var vPromotionCode1="";
	...
	$(".setting").live("click",function(){
	     ...
	     if($("#setting"+graphNameArea).hasClass("setting clicked")){
	    	 $("#setting"+graphNameArea).removeAttr("class");
	    	 $("#setting"+graphNameArea).addClass("setting");
	    	 $("#setting"+graphNameArea+">span").removeAttr("class");
	    	 $("#setting"+graphNameArea+">span").addClass("ui-icon ui-icon-circle-triangle-s");
	     }else{
	    	 $("#setting"+graphNameArea).removeAttr("class");
	    	 $("#setting"+graphNameArea).addClass("setting clicked");
	    	 $("#setting"+graphNameArea+">span").removeAttr("class");
	    	 $("#setting"+graphNameArea+">span").addClass("ui-icon ui-icon-circle-triangle-n");
	     }
