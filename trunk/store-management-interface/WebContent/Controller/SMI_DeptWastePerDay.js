...
function createChart_SMI_DeptWastePerDay(graphName,graphType,graphSeries,graphCategory,arIndex) {
	//alert(graphName);
...
var htmlParam_SMI_DeptWastePerDay = function(){
	 var htmlParam ="";
...
function deptWastePerDayFn(graphName,graphType,arIndex,startDate,endDate,brach){
	// alert("salePerDay22222222222222222222222");
	 $.ajax({
			 ...
			 */
				...
				//console.log(series);
				 createChart_SMI_DeptWastePerDay(graphName,graphType,series,objCategories,arIndex);
			}
		});
	};
